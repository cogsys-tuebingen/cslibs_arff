...
class ArffValue {
public:
    typedef std::shared_ptr<ArffValue> Ptr;
     ...
     */
    ArffValue(const std::string& str, const bool convert = true, const bool is_date = false);
     ...
     */
    ArffValue(const ArffValueEnum type);
